...
using Conekta_NetStandard.Models;
...
namespace Conekta_NetStandard
{
    public class Order : Resource
    {
        ...
        public Order()
        {
            this.line_items = new ConektaList(typeof(Conekta_NetStandard.LineItem));
            this.shipping_lines = new ConektaList(typeof(Conekta_NetStandard.ShippingLine));
            this.tax_lines = new ConektaList(typeof(Conekta_NetStandard.TaxLine));
            this.discount_lines = new ConektaList(typeof(Conekta_NetStandard.DiscountLine));
            this.charges = new ConektaList(typeof(Conekta_NetStandard.Charge));
            this.returns = new ConektaList(typeof(Conekta_NetStandard.Return));
        }
